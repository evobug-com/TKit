...
class TKitSpacing {
  ...
  static const double md = 12.0;  // Medium - default spacing
  static const double lg = 16.0;  // Large - comfortable spacing
  static const double xl = 20.0;  // Extra large - generous spacing
  static const double xxl = 24.0; // Double extra large - section spacing
  ...
  static const double headerGap = 3.0;      // Gap between header title and subtitle
}
